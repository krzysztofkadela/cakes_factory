...
urlpatterns = [
    ...
    path(
        "cart/update/<int:product_id>/<int:size_id>/",
        views.cart_update,
        name="cart_update",
    ),
    path(
        "cart/remove/<int:product_id>/<int:size_id>/",
        views.cart_remove,
        name="cart_remove",
    ),
    # Checkout & Orders
    ...
    path(
        "admin/update-order-status/<str:order_number>/<str:status>/",
        views.update_order_status,
        name="update_order_status",
    ),
]
