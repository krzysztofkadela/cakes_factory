...
urlpatterns = [
    ...
    path(
        "manage/subscriptions/toggle/<int:subscriber_id>/",
        views.toggle_subscription,
        name="toggle_subscription",
    ),
    path(
        "manage/subscriptions/delete/<int:subscriber_id>/",
    ...
    path(
        "manage/users/<int:user_id>/edit/", views.edit_user, name="edit_user"
    ),
    path(
