...
class CustomUser(AbstractUser):
    ...
    shipping_street_address1 = models.CharField(max_length=255, blank=True, null=True)
    shipping_street_address2 = models.CharField(max_length=255, blank=True, null=True)
    shipping_city = models.CharField(max_length=100, blank=True, null=True)
    shipping_postcode = models.CharField(max_length=20, blank=True, null=True)
    shipping_country = CountryField(blank_label="Select country", blank=True, null=True)
    ...
    billing_street_address2 = models.CharField(max_length=255, blank=True, null=True)
    billing_city = models.CharField(max_length=100, blank=True, null=True)
    billing_postcode = models.CharField(max_length=20, blank=True, null=True)
    billing_country = CountryField(blank_label="Select country", blank=True, null=True)
